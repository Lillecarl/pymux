...
def test_palette_reply_is_read_by_index():
...
def test_reply_split_across_reads_is_read_when_it_is_whole():
...
def test_replies_of_other_things_are_ignored():
    garbage = (
        b"typed keys \r\n"
...
def test_painter_paints_what_it_was_told():
...
def test_painter_falls_back_to_convention():
    painter = Painter({})
